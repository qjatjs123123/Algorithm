...
//    	BufferedReader br = new BufferedReader(new FileReader("./input.txt"));
        ...
        int one = dijkstra(1, from);
        int two = dijkstra(from, to);
        int three = dijkstra(to, N);
        int case1 = one + two + three;
        
        if (one == Integer.MAX_VALUE || two == Integer.MAX_VALUE || three == Integer.MAX_VALUE) case1 = Integer.MAX_VALUE;
        one = dijkstra(1, to);
        two = dijkstra(to, from);
        three = dijkstra(from, N);
        int case2 = one + two + three;
        if (one == Integer.MAX_VALUE || two == Integer.MAX_VALUE || three == Integer.MAX_VALUE) case2 = Integer.MAX_VALUE;
